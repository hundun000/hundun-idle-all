...
public class DemoConstructionPrototypeId {
    ...
    public static final String COOKIE_SIMPLE_AUTO_PROVIDER = "ENUM_CSTR@COOKIE_SIMPLE_AUTO_PROVIDER";
    public static final String COOKIE_COMPLEX_AUTO_PROVIDER = "ENUM_CSTR@COOKIE_COMPLEX_AUTO_PROVIDER";
