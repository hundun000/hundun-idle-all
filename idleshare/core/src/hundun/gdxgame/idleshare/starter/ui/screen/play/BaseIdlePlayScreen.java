package hundun.gdxgame.idleshare.starter.ui.screen.play;
...
import hundun.gdxgame.idleshare.framework.callback.IAchievementUnlockCallback;
import hundun.gdxgame.idleshare.framework.callback.ISecondaryInfoBoardCallback;
...
import hundun.gdxgame.idleshare.starter.ui.component.IdleEntityArea;
...
public abstract class BaseIdlePlayScreen<T_GAME extends BaseIdleGame<T_SAVE>, T_SAVE>
    ...
    protected void lazyInitLogicContext() {
        ...
        logicFrameListeners.add(game.getManagerContext().getStorageManager());
